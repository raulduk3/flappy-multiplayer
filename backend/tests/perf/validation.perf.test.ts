...
// Import via ws barrel to avoid direct .ts extension while satisfying NodeNext explicit extension enforcement
import { validateMessage } from "../../src/ws/index.ts";
...
describe("validation performance (T036)", () => {
  ...
  (skip ? test.skip : test)(
    "average validation under 5ms per call (synthetic)",
    () => {
