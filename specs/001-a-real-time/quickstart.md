...
2. Send `hello`:
   ```json
   {"type":"hello","protocol_version":"1.0.0","client_info":{"client":"web","version":"dev"}}
   ```
...
- Example flap:
  ```json
  {"type":"input","protocol_version":"1.0.0","seq":1,"action":"flap","ts":1695484800000}
  ```
- Sequence numbers MUST increase per client session.

## Engraving Name
```json
{"type":"engrave","protocol_version":"1.0.0","run_id":"r1","name":"PlayerOne"}
```
...
```json
{
  ...
  "server_tick":1200,
  "players":[{"id":"p1","x":10,"y":200,"vx":0,"vy":-2,"state":"alive"}],
  "pipes_window":{"x":[300,550],"gapY":[220,230],"gapH":[120,120],"id":["a","b"]},
  "leaderboard_topN":[{"player_id":"p1","name":"PlayerOne","score":12,"rank":1,"at":1200}]
}
```
